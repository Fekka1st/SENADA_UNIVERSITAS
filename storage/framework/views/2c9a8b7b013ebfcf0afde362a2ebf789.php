...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Pengajuan Rencana Kerja Sama <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.filter-bar','data' => ['searchId' => 'searchRencana','searchPlaceholder' => 'Cari Judul Rencana atau Mitra...','hasDateFilter' => false,'hasExport' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['searchId' => 'searchRencana','searchPlaceholder' => 'Cari Judul Rencana atau Mitra...','hasDateFilter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'hasExport' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
                 <?php $__env->slot('additionalButtons', null, []); ?> 
                    <?php if (\Illuminate\Support\Facades\Blade::check('permission', 'rencana_kerjasama.create')): ?>
                    <a href="<?php echo e(route('rencana-kerjasama.create')); ?>" class="btn btn-primary d-flex align-items-center gap-2 shadow-sm">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.wrapper','data' => ['tableId' => 'rencanaTable','columns' => ['No', 'Mitra', 'Judul Rencana', 'Unit / Prodi', 'Status', 'Aksi'],'hasCheckbox' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tableId' => 'rencanaTable','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['No', 'Mitra', 'Judul Rencana', 'Unit / Prodi', 'Status', 'Aksi']),'hasCheckbox' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.scripts','data' => ['tableId' => 'rencanaTable','ajaxUrl' => ''.e(route('rencana-kerjasama.getData')).'','columns' => $columnsConfig,'searchId' => 'searchRencana','perPageId' => 'perPage']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tableId' => 'rencanaTable','ajaxUrl' => ''.e(route('rencana-kerjasama.getData')).'','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($columnsConfig),'searchId' => 'searchRencana','perPageId' => 'perPage']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.hapus','data' => ['id' => 'modalHapusRencana','title' => 'Hapus Pengajuan Rencana','isDynamic' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalHapusRencana','title' => 'Hapus Pengajuan Rencana','isDynamic' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <script>
        $(document).on('click', '.btn-delete', function() {
            ...
            $('#modalHapusRencanaForm').attr('action', '<?php echo e(route("rencana-kerjasama.destroy", ":id")); ?>'.replace(':id', id));
...
<?php endif; ?>
<?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/rencana_kerjasama/index.blade.php ENDPATH**/ ?>