    ...
    <div class="container-fluid">
        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                    ...
                    <div class="dropdown-user-scroll scrollbar-outer d-flex flex-column">
                        ...
                        <li class="notification-footer border-top bg-white sticky-bottom">
                            <div class="p-2 text-center">
                                <a href="<?php echo e(route('notifikasi.index')); ?>" class="btn btn-primary w-100" style="font-weight:600"> Lihat semua notifikasi
                                </a>
                            </div>
                        </li>
                    </div>
            ...
            <li class="nav-item topbar-user dropdown hidden-caret">
                ...
                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false" title="<?php echo e($userName); ?>">
                    <div class="avatar-sm">
                        <img src="<?php echo e(safe_image_url($userFoto, 'foto_user', 'images/avatar.png')); ?>" alt="image profile" class="avatar-img rounded-circle">
                    </div>
                    <span class="profile-username">
                        <span class="fw-bold"><?php echo e($userName); ?></span>
                    </span>
                </a>
                        ...
                        <li>
                            <div class="user-box">
                                ...
                                <div class="u-text">
                                    ...
                                    <p class="text-muted"><?php echo e($currentUser->roleModel->nama ?? auth()->user()->roleModel->nama); ?></p>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <?php if (\Illuminate\Support\Facades\Blade::check('permission', 'profile.edit')): ?>
                            <a href="<?php echo e(route('profil.edit')); ?>" class="dropdown-item py-2">
                                <i class="ti ti-user fs-5 me-2"></i> Edit Profil
                            </a>
                            <?php endif; ?>

                            <?php if (\Illuminate\Support\Facades\Blade::check('permission', 'password.change')): ?>
                            <a href="<?php echo e(route('password.edit')); ?>" class="dropdown-item py-2">
...
function loadNotifications() {
    const NOTIF_BASE = (window.NOTIF_BASE || (window.NOTIF_URLS && window.NOTIF_URLS.base) || '<?php echo e(url('/notifikasi')); ?>');
...
function bukaNotifikasi(id) {
    const BASE = (window.NOTIF_BASE || (window.NOTIF_URLS && window.NOTIF_URLS.base) || '<?php echo e(url('/notifikasi')); ?>');
...
function tandaiSemuaDibaca() {
    const URL_TANDAI_SEMUA = (window.NOTIF_URLS && window.NOTIF_URLS.tandaiSemua) || ((window.NOTIF_BASE || '<?php echo e(url('/notifikasi')); ?>') + '/tandai-semua-dibaca');
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/layouts/navbar-header.blade.php ENDPATH**/ ?>