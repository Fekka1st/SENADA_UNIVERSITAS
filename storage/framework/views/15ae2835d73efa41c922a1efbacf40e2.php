...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Edit Registrasi MoU <?php $__env->endSlot(); ?>
     <?php $__env->slot('breadcrumb', null, []); ?> Kerjasama / MoU / Edit / <?php echo e($mou->nomor_mou); ?> <?php $__env->endSlot(); ?>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(route('berkas-MoU.update', $mou->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <p class="text-muted small mb-0" style="line-height: 1.5;">
                                            MoU ini berasal dari pengajuan <strong>Prodi
                                                <?php echo e($mou->rencana->user->prodi->nama_prodi ?? '-'); ?></strong>. Kolom
                        ...
                        <div class="card-body p-4">
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <?php if($mou->rencana_id): ?>
                                        <input type="hidden" name="mitra_id" value="<?php echo e($mou->mitra_id); ?>">
                                        <div
                                            ...
                                            <span class="fw-medium text-dark"><?php echo e($mou->mitra->nama_mitra); ?></span>
                                        </div>
                                    <?php else: ?>
                                        <select name="mitra_id"
                                            ...
                                            <?php $__currentLoopData = $mitras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($mitra->id); ?>"
                                                    <?php echo e(old('mitra_id', $mou->mitra_id) == $mitra->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="judul_mou" class="form-control bg-light border-0 py-2 px-3" rows="2" required><?php echo e(old('judul_mou', $mou->judul_mou)); ?></textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="usulan_durasi_tahun" class="form-select border-0 bg-light py-2 px-3"
                                        ...
                                        <option value="1"
                                            <?php echo e(old('usulan_durasi_tahun', $mou->usulan_durasi_tahun) == '1' ? 'selected' : ''); ?>>
                                            1 Tahun</option>
                                        <option value="3"
                                            <?php echo e(old('usulan_durasi_tahun', $mou->usulan_durasi_tahun) == '3' ? 'selected' : ''); ?>>
                                            3 Tahun</option>
                                        <option value="5"
                                            <?php echo e(old('usulan_durasi_tahun', $mou->usulan_durasi_tahun) == '5' ? 'selected' : ''); ?>>
                                ...
                                <div class="col-12">
                                    <label class="form-label fw-semibold small text-dark">Ringkasan Poin
                                        Kerjasama</label>
                                    <textarea name="deskripsi" class="form-control bg-light border-0 py-2 px-3" rows="4"><?php echo e(old('deskripsi', $mou->deskripsi_singkat)); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sticky-top" style="top: 20px;">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                            <div
                                ...
                                <span
                                    ...
                                    <?php echo e($mou->files ? $mou->files->count() : 0); ?> File Tersimpan
                                </span>
                            </div>
                            <div class="card-body p-4">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $mou->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <div class="d-flex align-items-center p-2 bg-light rounded-3 border old-file-item"
                                                ...
                                                <div class="ms-2 d-flex gap-1">
                                                    ...
                                                    <a href="<?php echo e(route('berkas-MoU.view-file', $file->id)); ?>"
                                                        target="_blank"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-nama="<?php echo e($file->nama_file); ?>" title="Hapus Dokumen">
                        ...
                        <div class="card border-0 shadow-sm rounded-4">
                            <div class="card-body p-4 text-center">
                                ...
                                <a href="<?php echo e(route('berkas-MoU.show', $mou->id)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/kerjasama/berkas_mou/edit.blade.php ENDPATH**/ ?>