...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Repository Kerja Sama <?php echo e(Auth::user()->fakultas->nama_fakultas ?? 'Universitas'); ?> <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.filter-bar','data' => ['searchId' => 'searchRepository','searchPlaceholder' => 'Cari Judul atau Nomor Dokumen...','hasDateFilter' => false,'hasExport' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['searchId' => 'searchRepository','searchPlaceholder' => 'Cari Judul atau Nomor Dokumen...','hasDateFilter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'hasExport' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
                     <?php $__env->slot('additionalButtons', null, []); ?> 
                        <?php if (\Illuminate\Support\Facades\Blade::check('permission', 'repository.create')): ?>
                        <a href="<?php echo e(route('Repository_kerjasama.create')); ?>" class="btn btn-primary d-flex align-items-center gap-2 shadow-sm px-3">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.wrapper','data' => ['tableId' => 'repositoryTable','columns' => ['No', 'Dokumen', 'Penanggung Jawab (Mitra)', 'Masa Berlaku', 'Nilai Kontrak', 'Status', 'Aksi'],'hasCheckbox' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tableId' => 'repositoryTable','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['No', 'Dokumen', 'Penanggung Jawab (Mitra)', 'Masa Berlaku', 'Nilai Kontrak', 'Status', 'Aksi']),'hasCheckbox' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.scripts','data' => ['tableId' => 'repositoryTable','ajaxUrl' => ''.e(route('Repository_kerjasama.getData')).'','columns' => $columnsConfig,'searchId' => 'searchRepository','perPageId' => 'perPage']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tableId' => 'repositoryTable','ajaxUrl' => ''.e(route('Repository_kerjasama.getData')).'','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($columnsConfig),'searchId' => 'searchRepository','perPageId' => 'perPage']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.hapus','data' => ['id' => 'modalHapusRepo','title' => 'Hapus Data Repository','isDynamic' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalHapusRepo','title' => 'Hapus Data Repository','isDynamic' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <script>
        $(document).on('click', '.btn-delete', function() {
            ...
            $('#modalHapusRepoForm').attr('action', '<?php echo e(route("Repository_kerjasama.destroy", ":id")); ?>'.replace(':id', id));
...
<?php endif; ?>
<?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/Repository/index.blade.php ENDPATH**/ ?>