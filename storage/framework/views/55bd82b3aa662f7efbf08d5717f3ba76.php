...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Edit Sasaran Kerja <?php $__env->endSlot(); ?>
     <?php $__env->slot('breadcrumb', null, []); ?> Master Data / Sasaran Kerja / Edit <?php $__env->endSlot(); ?>
...
<?php endif; ?>
                    ...
                    <form action="<?php echo e(route('master-data.sasaran_kerja.update', $sasaranKerja->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group shadow-sm rounded-3 overflow-hidden">
                                    ...
                                    <input type="text" name="nama_sasaran"
                                        class="form-control bg-light border-start-0 py-2 <?php $__errorArgs = ['nama_sasaran'];
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('nama_sasaran', $sasaranKerja->nama_sasaran)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Penjelasan detail mengenai sasaran ini..."><?php echo e(old('keterangan', $sasaranKerja->keterangan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-5 text-end">
                            <hr class="opacity-10 mb-4">
                            <a href="<?php echo e(route('master-data.sasaran_kerja.index')); ?>" class="btn btn-light fw-bold px-4 me-2 rounded-pill hover-dark">
...
<?php endif; ?>
<?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/master_data/sasaran_kerja/edit.blade.php ENDPATH**/ ?>