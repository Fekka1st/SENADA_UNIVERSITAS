...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Edit Jenis Dokumen: <?php echo e($jenisDokumen->nama_jenis); ?> <?php $__env->endSlot(); ?>
...
<?php endif; ?>
            ...
            <form action="<?php echo e(route('master-data.jenis_dokumen.update', $jenisDokumen->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('kode_inisial', $jenisDokumen->kode_inisial)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('nama_jenis', $jenisDokumen->nama_jenis)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Jelaskan secara singkat kegunaan jenis dokumen ini..."><?php echo e(old('keterangan', $jenisDokumen->keterangan)); ?></textarea>
                        ...
                        <div class="card border-dashed bg-light bg-opacity-50 h-100">
                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                ...
                                <p class="small text-muted mb-4">
                                    Anda sedang mengubah tipe dokumen <strong><?php echo e($jenisDokumen->nama_jenis); ?></strong>.
                                </p>
                                ...
                                <div class="p-3 bg-white rounded-3 border shadow-sm text-start mb-3">
                                    ...
                                    <div class="small">
                                        <span class="d-block">Dibuat: <strong><?php echo e($jenisDokumen->created_at->format('d/m/Y')); ?></strong></span>
                                        <span class="d-block">Update: <strong><?php echo e($jenisDokumen->updated_at->diffForHumans()); ?></strong></span>
                                    </div>
                                </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/master_data/jenis_dokumen/edit.blade.php ENDPATH**/ ?>