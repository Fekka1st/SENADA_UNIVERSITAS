...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Detail Rencana Kerjasama <?php $__env->endSlot(); ?>
     <?php $__env->slot('breadcrumb', null, []); ?> Rencana / Detail / <?php echo e($rencana->judul_rencana); ?> <?php $__env->endSlot(); ?>
...
<?php endif; ?>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    ...
                    <div class="card-body p-4">
                        <h3 class="fw-bold text-dark mb-3"><?php echo e($rencana->judul_rencana); ?></h3>

                        <div class="d-flex flex-wrap gap-3 mb-4">
                            <div class="small text-muted">
                                <i class="ti ti-user me-1"></i> Diajukan oleh:
                                <strong><?php echo e($rencana->user->nama_user); ?></strong>
                            </div>
                            <div class="small text-muted">
                                <i class="ti ti-building me-1"></i> Fakultas:
                                <strong><?php echo e($rencana->fakultas->nama_fakultas ?? '-'); ?></strong>
                            </div>
                            <div class="small text-muted">
                                <i class="ti ti-school me-1"></i> Prodi:
                                <strong><?php echo e($rencana->user->prodi->nama_prodi ?? '-'); ?></strong>
                            </div>
                            <div class="small text-muted">
                                <i class="ti ti-calendar me-1"></i> Tgl:
                                <strong><?php echo e($rencana->created_at->format('d M Y')); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="bg-light rounded-4 p-4 border border-secondary-subtle border-start border-primary border-4 position-relative overflow-hidden">
                            <div class="position-relative z-1">
                                ...
                                <div class="text-dark fw-medium" style="line-height: 1.8; font-size: 0.95rem;">
                                    <?php echo nl2br(e($rencana->deskripsi ?? 'Tidak ada ringkasan deskripsi yang ditambahkan untuk dokumen ini.')); ?>
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-header bg-white border-bottom py-3">
                        <h6 class="fw-bold mb-0"><i class="ti ti-files me-2 text-primary"></i>Berkas Pendukung
                            (<?php echo e($rencana->files->count()); ?>)</h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div
                                        ...
                                        <div class="bg-light p-2 rounded-3 me-3">
                                            <?php if(Str::contains($file->type_file, 'pdf')): ?>
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="mb-0 text-truncate fw-bold small text-dark"><?php echo e($file->nama_file); ?>

                                            </p>
                                            <small class="text-muted"><?php echo e(formatBytes($file->size)); ?></small>
                                        </div>
            ...
            <div class="col-lg-4">
                ...
                <?php if(auth()->user()->role == 4 && $rencana->status == '4'): ?>
                    <div
                        ...
                        <div class="card-body p-4 pt-2">
                            <a href="<?php echo e(route('rencana-kerjasama.edit', $rencana->id)); ?>"
                ...
                <?php if(auth()->user()->role != 4 && $rencana->status == '1'): ?>
                    <div
                        ...
                        <div class="card-body p-4 pt-2">
                            <div class="d-grid gap-2">
                                ...
                                <form action="<?php echo e(route('rencana-kerjasama.update-feedback', $rencana->id)); ?>"
                                    method="POST"
                ...
                <?php if(in_array($rencana->status, ['2', '3', '4'])): ?>
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-header bg-<?php echo e($currStatus['class']); ?> bg-opacity-10 border-0 py-3">
                            <h6 class="mb-0 fw-bold <?php echo e(Str::replace('bg-', 'text-', $currStatus['class'])); ?>">
                                <i class="ti ti-message-dots me-2"></i>Catatan Verifikator
                            </h6>
                        </div>
                        <div class="card-body p-4">
                            <div
                                class="p-3 bg-light rounded-4 border-start border-<?php echo e(Str::replace('bg-', '', $currStatus['class'])); ?> border-4">
                                <p class="small text-dark mb-0 fw-medium">
                                    "<?php echo e($rencana->feedback_internal ?? 'Tidak ada catatan tambahan.'); ?>"</p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <div class="bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 rounded-circle d-flex align-items-center justify-content-center fw-bold fs-3 me-3 flex-shrink-0 shadow-sm"
                                ...
                                <?php echo e(strtoupper(substr($rencana->mitra->nama_mitra, 0, 1))); ?>

                            </div>
                            <div>
                                <h5 class="fw-bold text-dark mb-1"><?php echo e($rencana->mitra->nama_mitra); ?></h5>
                                <span class="badge bg-light text-muted border border-secondary-subtle fw-medium">
                                    <i class="ti ti-map-pin me-1 text-danger"></i><?php echo e($rencana->mitra->negara); ?>
                        ...
                        <div class="p-3 bg-light rounded-4 mb-4 border border-secondary-subtle">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <span class="text-dark fw-bold small">
                                    <?php echo e($rencana->ruangLingkup->nama_ruanglingkup ?? 'Belum ada ruang lingkup spesifik'); ?>
                        ...
                        <a href="<?php echo e(route('Manajemen-Mitra.show', $rencana->mitra_id)); ?>"
    ...
    <div class="modal fade" id="modalAction" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <form action="<?php echo e(route('rencana-kerjasama.update-feedback', $rencana->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/rencana_kerjasama/detail.blade.php ENDPATH**/ ?>