...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Daftar Ruang Lingkup Kerja Sama <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.filter-bar','data' => ['searchId' => 'searchRuangLingkup','searchPlaceholder' => 'Cari Ruang Lingkup...','hasDateFilter' => false,'hasExport' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['searchId' => 'searchRuangLingkup','searchPlaceholder' => 'Cari Ruang Lingkup...','hasDateFilter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'hasExport' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
                 <?php $__env->slot('additionalButtons', null, []); ?> 
                    <?php if (\Illuminate\Support\Facades\Blade::check('permission', 'ruang_lingkup.create')): ?>
                    <a href="<?php echo e(route('master-data.ruang_lingkup.create')); ?>" class="btn btn-primary d-flex align-items-center gap-1">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.wrapper','data' => ['tableId' => 'ruangLingkupTable','columns' => ['No', 'Nama Ruang Lingkup', 'Keterangan', 'Aksi'],'hasCheckbox' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tableId' => 'ruangLingkupTable','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['No', 'Nama Ruang Lingkup', 'Keterangan', 'Aksi']),'hasCheckbox' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.scripts','data' => ['tableId' => 'ruangLingkupTable','ajaxUrl' => ''.e(route('master-data.ruang_lingkup.getData')).'','columns' => $columnsConfig,'searchId' => 'searchRuangLingkup','perPageId' => 'perPage']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tableId' => 'ruangLingkupTable','ajaxUrl' => ''.e(route('master-data.ruang_lingkup.getData')).'','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($columnsConfig),'searchId' => 'searchRuangLingkup','perPageId' => 'perPage']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.hapus','data' => ['id' => 'modalHapusRuangLingkup','title' => 'Hapus Ruang Lingkup','isDynamic' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalHapusRuangLingkup','title' => 'Hapus Ruang Lingkup','isDynamic' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <script>
        $(document).on('click', '.btn-delete', function() {
            ...
            $('#modalHapusRuangLingkupForm').attr('action', '<?php echo e(route("master-data.ruang_lingkup.destroy", ":id")); ?>'.replace(':id', id));
...
<?php endif; ?>
<?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/master_data/ruang_lingkup/index.blade.php ENDPATH**/ ?>