...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Daftar Prodi: <?php echo e($fakultas->nama_fakultas); ?> <?php $__env->endSlot(); ?>
     <?php $__env->slot('breadcrumb', null, []); ?> Detail Prodi <?php $__env->endSlot(); ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="fw-bold mb-0">Fakultas <?php echo e($fakultas->nama_fakultas); ?></h4>
                    <p class="text-muted mb-0">Manajemen daftar program studi di bawah naungan fakultas ini.</p>
                </div>
                <div class="text-end">
                    <span class="badge bg-primary-subtle text-primary border border-primary-subtle px-3 py-2">
                        Akreditasi Fakultas: <strong><?php echo e($fakultas->akreditasi_fakultas); ?></strong>
                    </span>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.filter-bar','data' => ['searchId' => 'searchProdi','searchPlaceholder' => 'Cari nama prodi...','hasDateFilter' => false,'hasExport' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['searchId' => 'searchProdi','searchPlaceholder' => 'Cari nama prodi...','hasDateFilter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'hasExport' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>

                 <?php $__env->slot('additionalButtons', null, []); ?> 
                    
                    <a href="<?php echo e(route('master-data.daftar_fakultas.index')); ?>" class="btn btn-light d-flex align-items-center gap-1">
                        <i class="ti ti-arrow-left"></i>Kembali
                    </a>
                    
                    <?php if (\Illuminate\Support\Facades\Blade::check('permission', 'prodi.create')): ?>
                    <a href="<?php echo e(route('master-data.daftar_fakultas.create', ['fakultas_id' => $fakultas->id])); ?>" class="btn btn-primary d-flex align-items-center gap-1">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.per-page','data' => ['selectId' => 'perPageProdi','default' => 10]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['selectId' => 'perPageProdi','default' => 10]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.wrapper','data' => ['tableId' => 'prodiDetailTable','columns' => [
                    'No',
                    'Nama Program Studi',
                    'Akreditasi Prodi',
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tableId' => 'prodiDetailTable','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                    'No',
                    'Nama Program Studi',
                    'Akreditasi Prodi',
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable.scripts','data' => ['tableId' => 'prodiDetailTable','ajaxUrl' => ''.e(route('master-data.daftar_prodi.getData')).'','columns' => $columnsConfig,'order' => [[1, 'asc']],'searchId' => 'searchProdi','perPageId' => 'perPageProdi','hasDateFilter' => false,'hasExport' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tableId' => 'prodiDetailTable','ajaxUrl' => ''.e(route('master-data.daftar_prodi.getData')).'','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($columnsConfig),'order' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([[1, 'asc']]),'searchId' => 'searchProdi','perPageId' => 'perPageProdi','hasDateFilter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'hasExport' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
        
         <?php $__env->slot('customAjaxData', null, []); ?> 
            d.fakultas_id = "<?php echo e($fakultas->id); ?>";
         <?php $__env->endSlot(); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.hapus','data' => ['id' => 'modalHapusProdi','title' => 'Hapus Program Studi','isDynamic' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalHapusProdi','title' => 'Hapus Program Studi','isDynamic' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-delete-prodi', function() {
                ...
                const url = '<?php echo e(route("master-data.daftar_prodi.destroy", ":id")); ?>'.replace(':id', id);
...
<?php endif; ?>
<?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/master_data/daftar_fakultas/detail.blade.php ENDPATH**/ ?>