...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Tambah Arsip Repository <?php $__env->endSlot(); ?>
     <?php $__env->slot('breadcrumb', null, []); ?> Repository / Kerjasama / Tambah <?php $__env->endSlot(); ?>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(route('Repository_kerjasama.store')); ?>" method="POST" enctype="multipart/form-data"
            id="mainForm">
            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="jenis_dokumen_id" class="form-select bg-light border-0" required>
                                        ...
                                        <?php $__currentLoopData = $jenisDokumens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($jenis->id); ?>"><?php echo e($jenis->nama_jenis); ?></option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="pihak[0][mitra_id]"
                                                    ...
                                                    <?php $__currentLoopData = $mitras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($mitra->id); ?>"><?php echo e($mitra->nama_mitra); ?>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select name="kegiatan[0][jenis_kegiatan_id]"
                                                ...
                                                <?php $__currentLoopData = $jenisKegiatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($jk->id); ?>"><?php echo e($jk->nama_kegiatan); ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="kegiatan[0][sasaran_kerja_id]"
                                                ...
                                                <?php $__currentLoopData = $sasaranKerjas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sasaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($sasaran->id); ?>"><?php echo e($sasaran->nama_sasaran); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ferry\Documents\SENADA\resources\views/repository/create.blade.php ENDPATH**/ ?>