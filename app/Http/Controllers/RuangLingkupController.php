...
class RuangLingkupController extends Controller
{
    ...
    {
        return view('master_data.ruang_lingkup.index');
    }

    public function getData()
    {
        $query = RuangLingkup::query()->latest();
        return DataTables::of($query)
            ...
            ->addColumn('action', function ($row) {
                ...
                // Tombol Edit
                $btn .= '<a href="' . route('master-data.ruang_lingkup.edit', $row->id) . '"
    ...
    {
        return view('master_data.ruang_lingkup.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'nama_ruanglingkup.required' => 'Nama ruang lingkup wajib diisi.',
            'nama_ruanglingkup.unique'   => 'Nama ruang lingkup ini sudah ada.',
        ...
        try {
            ...
            return redirect()->route('master-data.ruang_lingkup.index')
    ...
    public function edit($id)
    {
        ...
        return view('master_data.ruang_lingkup.edit', compact('ruangLingkup'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            'nama_ruanglingkup' => 'required|string|max:150|unique:ruanglingkup,nama_ruanglingkup,' . $id,
            'deskripsi'    => 'nullable|string|max:500',
        ], [
            'nama_ruanglingkup.required' => 'Nama ruang lingkup tidak boleh kosong.',
            'nama_ruanglingkup.unique'   => 'Nama ruang lingkup sudah digunakan.',
        ]);
        ...
        try {
            ...
            return redirect()->route('master-data.ruang_lingkup.index')
                ->with('success', "Ruang lingkup {$ruangLingkup->nama_lingkup} berhasil diperbarui!");
        } catch (\Throwable $e) {
            DB::rollBack();
            Log::error("Gagal update ruang lingkup", ['id' => $id, 'error' => $e->getMessage()]);
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error("Gagal hapus ruang lingkup", ['id' => $id, 'error' => $e->getMessage()]);
