    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('role.store') }}" method="POST">
                                        ...
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="permission-module-card h-100">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input module-check-all" type="checkbox" 
                                                                   data-module="{{ $module }}" id="checkAll_{{ $module }}">
                                                            <label class="form-check-label small text-muted" for="checkAll_{{ $module }}">
                                                                Semua
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="module-permissions">
                                                    ...
                                                    <div class="form-check permission-item {{ $isBasePermission ? 'base-permission' : '' }}">
                                                        <input 
                                                        ...
                                                        <label class="form-check-label" for="permission_{{ $permission->id }}">
                                                            ...
                                                            @elseif(str_contains($permission->name, 'download'))
                ...
                {{-- action buttons --}}
                <x-page-action-buttons route="role" />
            </form>
        </div>
    </div>
