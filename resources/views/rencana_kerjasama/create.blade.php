<x-app-layout>
    <x-slot:title>Ajukan Rencana Kerjasama</x-slot:title>
    <x-slot:breadcrumb>Kerjasama / Rencana / Baru</x-slot:breadcrumb>

    <div class="container-fluid">
        <x-alert></x-alert>

        <form action="{{ route('rencana-kerjasama.store') }}" method="POST" enctype="multipart/form-data" id="mainForm">
            @csrf
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="judul_rencana" class="form-control bg-light border-0 py-2 px-3" placeholder="Contoh: Rencana Kerjasama Pelatihan Sertifikasi Cloud Computing" required value="{{ old('judul_rencana') }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted" style="font-size: 11px;">
                                        Mitra tidak ada? <a href="{{ route('Manajemen-Mitra.create') }}" class="text-primary fw-bold">Tambah Mitra Baru</a>
                                    </small>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="ruanglingkup_id" class="form-select select-scope border-0 bg-light py-2" required>
                                        ...
                                        @forelse($ruangLingkups ?? [] as $scope)
                                            <option value="{{ $scope->id }}" {{ old('ruanglingkup_id') == $scope->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="deskripsi" class="form-control bg-light border-0 py-2 px-3" rows="8" placeholder="Jelaskan secara detail mengenai latar belakang, potensi manfaat bagi unit, dan target yang ingin dicapai..." required>{{ old('deskripsi') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sticky-top" style="top: 20px; z-index: 10;">
                        ...
                        <div class="card border-0 shadow-lg rounded-4 overflow-hidden mb-4">
                            <div class="card-body p-4 text-center">
                                ...
                                <a href="{{ route('rencana-kerjasama.index') }}" class="btn btn-link btn-sm text-muted text-decoration-none hover-danger">
